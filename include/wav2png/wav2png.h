 ...
 */
static std::vector<MinMax> createPreviewFromWav(const std::vector<float> &wav,
                                                int resolution = 128) {
 ...
 */
std::vector<rgba> renderToBitmap(const std::vector<MinMax> &preview, int height,
                                 rgba bg = rgba(0, 0, 0),
...
bool writeToBinary(const std::vector<float> &wav, const std::string &outputFile,
                   int width = 256) {
